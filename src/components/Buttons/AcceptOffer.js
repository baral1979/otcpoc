...
class AcceptOffer extends React.Component {
  ...
  render() {
    ...
    return (
      <ModalButton visible={this.props.contract.contractState == 3} disabled={this.props.disabled} success={this.ok.bind(this)} buttonText="Purchase" title="Purchase Offer" content={<div>
        <h5>Buyer Address</h5>
          <Address address={this.props.address} showBalance={true}/>
          <h5>Enter Units (in Finney)</h5>
