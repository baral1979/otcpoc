    ...
    return (<div className="panel panel-default">
      ...
      <div className="panel-body">
        ...
        <div>
          ...
          <DefineContingentPayment contract={this.props.contract} onCreate={this.props.onLeased} contract={this.props.contract} onError={this.props.onError} />
          <DefineSettlement show={this.props.contract.contractState==='2'} onCreate={this.props.onCreate} sellerAddress={this.props.contract.seller}/>
          <PostResult show={this.props.contract.contractState==='6'} onCreate={this.props.onCreate} />
        </div><br/><br/>
      <h5>Owner Actions</h5>
        <div>
          <ClaimBalance show={true} onCreate={this.props.onCreate}/>
          <SetRent show={true} onCreate={this.props.onCreate}/>
          <SellContract show={true} onCreate={this.props.onCreate}/>
        </div>
      </div>
    </div>);
  }
